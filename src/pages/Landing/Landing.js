...
const Landing = () => {
  const [typeableText, setTypeableText] = React.useState(" ");
  const availableTexts = ["Accurate", "Reliable", "Autonomous", "Better"];
  const [textIndex, setTextIndex] = React.useState(0);

  // Make a typing effect
        ...
        <section>
          <div>
            ...
            <span className="header">
              ...
              >
                <pre className="header">{typeableText}</pre>
              </span>{" "}
              predictability from a distance.
            </span>

            <p>
              Use <b>Overast</b> to discover weather changes and subscribe to
              our platform for SMS notifications on weather updates everyday.
            </p>
